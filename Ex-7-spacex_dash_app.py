...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        success_count = spacex_df[spacex_df['class'] == 1].groupby('Launch Site').size()
        fig = px.pie(values=success_count,
...
def get_scatter_chart(entered_site,payload_range):
    ...
    title = 'Correlation between Payload and Successful Launches',
